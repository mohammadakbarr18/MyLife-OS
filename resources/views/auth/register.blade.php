            ...
            <div class="order-2 lg:order-2 flex flex-col justify-center w-full max-w-md mx-auto lg:px-8 xl:px-12 lg:py-12 lg:bg-[#FEF6EF]">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <a href="{{ route('auth.google') }}" 
                       class="w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-gray-200 rounded-3xl shadow-sm text-sm font-semibold text-gray-600 bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FCE2CE] transition-all transform hover:scale-[1.01]">

                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5 lg:space-y-6">
                    ...
                    <div class="flex justify-center gap-6">
                        ...
                        <a href="{{ route('auth.google') }}" 
                           class="w-10 h-10 rounded-full bg-white border border-gray-200 shadow hover:shadow-md hover:border-gray-300 flex items-center justify-center transition-all duration-200 hover:scale-105">
                        ...
                        <div class="relative group cursor-not-allowed flex justify-center">
                            <!-- Tooltip -->
                            <span class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2
                                         bg-gray-800 text-white text-[10px] font-semibold rounded-md py-1 px-2.5 whitespace-nowrap
                            ...
                            <button type="button" disabled class="w-10 h-10 rounded-full bg-white border border-gray-100 shadow flex items-center justify-center pointer-events-none opacity-60">

                ...
                <div class="bg-white px-5 pb-4 pt-6 sm:px-8 sm:pb-6 sm:pt-8">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-sm text-gray-500 mt-2 leading-relaxed">
                            Apakah kamu yakin ingin menghapus prioritas
                            <span class="font-semibold text-[#3E2723]" x-text="deleteTarget.name"></span>?
                            Tugas yang masih memakai prioritas ini harus dipindahkan dulu.
                        </p>

                        <div class="mt-4 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1.5">
                            <span class="w-2.5 h-2.5 rounded-full" :style="'background-color: ' + deleteTarget.color"></span>
                            <span class="text-xs font-semibold text-gray-500" x-text="deleteTarget.color"></span>
                        </div>
                    </div>
                </div>
